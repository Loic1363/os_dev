...
static void console_submit_line() {
    ...
    if (streq(g_console_line, "help")) {
        print_str("Commands: help clear cls ticks time uptime echo about version panic_de panic_gp panic_pf\n");
    } else if (streq(g_console_line, "clear") || streq(g_console_line, "cls")) {
        print_clear();
    ...
    } else if (streq(g_console_line, "about")) {
        console_print_about();
    } else if (streq(g_console_line, "version")) {
        console_print_version();
    } else if (streq(g_console_line, "panic_de")) {
        print_str("Triggering #DE...\n");
        console_trigger_panic_de();
    } else if (streq(g_console_line, "panic_gp")) {
        print_str("Triggering #GP...\n");
        console_trigger_panic_gp();
    } else if (streq(g_console_line, "panic_pf")) {
